...
export const setLists = createAsyncThunk(
  ...
  async () => {
    const res = axios
      .get('https://react-todooo.herokuapp.com:3001/lists?_expand=color&_embed=tasks')
      .then(({ data }) => {
        return data
      })
    return res;
...
export const addList = createAsyncThunk(
  'lists/addList',
  async (list) => {
    axios.post('https://react-todooo.herokuapp.com:3001/lists', {
      name: list.name,
...
export const deleteList = createAsyncThunk(
  'lists/deleteList',
  async (listId) => {
    axios.delete('https://react-todooo.herokuapp.com:3001/lists/' + listId)
    return listId;
  }
)
...
export const editList = createAsyncThunk(
  'lists/editList',
  async (list) => {
    axios.patch('https://react-todooo.herokuapp.com:3001/lists/' + list.listId, { name: list.name })
    return list;
  }
)
